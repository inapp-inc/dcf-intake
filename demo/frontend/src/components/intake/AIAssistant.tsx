        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              ...
              />
              <span style={{ fontSize: 10, color: monitoring || sending ? C.green : C.textLight, fontWeight: 600 }}>
                {sending
                  ? "Thinking… (Hugging Face)"
                  : monitoring
                    ? "Active · Monitoring intake"
                    : "Standby"}
              </span>
            </div>
          </div>
      ...
      >
        ...
        {sending && (
          <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "4px 2px" }}>
            ...
            <span style={{ fontSize: 11, color: C.textLight }}>Waiting for assistant…</span>
          </div>
        )}
        {messages.map((m) => {
      ...
      <div style={{ padding: "11px 14px", borderTop: `1px solid ${C.border}`, background: C.white, flexShrink: 0 }}>
        <div style={{ display: "flex", gap: 7 }}>
          ...
          <button
            ...
            onClick={onSend}
          >
            {sending ? <LoadingSpinner size={16} color="#fff" /> : "↑"}
          </button>
        </div>
