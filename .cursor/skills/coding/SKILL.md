...
- When the slice involves APIs, **refer to the OpenAPI spec** for endpoints, request/response shapes, and types. If the API must change, **edit the OpenAPI spec first**, then implement against the updated spec.
...
All guidelines live under **`system-prompts-skills/coding-skills/`**. Use the one that matches the implementation target.

| Stack / Language | Primary reference | Additional |
|------------------|-------------------|------------|
| **React** | `system-prompts-skills/coding-skills/reactjs/SKILLS.md` | `_React JS Development Coding Guide Line.md` |
| **Node.js** | `system-prompts-skills/coding-skills/nodejs/SKILLS.md` | `Node JS Coding Guidelines ... .docx.md` |
| **JavaScript** | `system-prompts-skills/coding-skills/javascript/SKILLS.md` | `Javascript Coding Guidelines.docx.md` |
| **Python** | `system-prompts-skills/coding-skills/python/SKILLS.md` | `Python Coding Guide Line ... .docx.md` |
| **PHP** | `system-prompts-skills/coding-skills/php/SKILLS.md` | `PHP Coding Guide Line ... .docx.md` |
| **CI/CD** | `system-prompts-skills/coding-skills/ci-cd/SKILLS.md` | `CI_CD_Implementation Guidelines ... .docx.md` |
...
- **APIs:** Generate or consume clients and server stubs from the OpenAPI spec where the project supports it; keep types and payloads in sync with the spec.
